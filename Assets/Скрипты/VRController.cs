...
public class VRController : MonoBehaviour
{
    ...
    private void CalculateMovement()
    {
        ...
        Quaternion orientation = CalculateOrientetion();
        ...
        m_Speed = Mathf.Clamp(m_Speed, -m_Speed, m_MaxSpeed);

        // orientation and graviry
    ...
    private Quaternion CalculateOrientetion()
    {
